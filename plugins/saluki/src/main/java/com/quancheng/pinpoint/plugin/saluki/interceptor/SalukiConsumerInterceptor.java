...
public class SalukiConsumerInterceptor implements AroundInterceptor {
  ...
  public void before(Object target, Object[] args) {
    ...
    if (trace.canSampled()) {
      ...
      RpcContext.getContext().setAttachment(SalukiConstants.META_TRANSACTION_ID,
          nextId.getTransactionId());
      RpcContext.getContext().setAttachment(SalukiConstants.META_SPAN_ID,
          Long.toString(nextId.getSpanId()));
      ...
      RpcContext.getContext().setAttachment(SalukiConstants.META_FLAGS,
          Short.toString(nextId.getFlags()));
    } else {
  ...
  public void after(Object target, Object[] args, Object result, Throwable throwable) {
    ...
    try {
      ...
      if (throwable == null) {
        String endPoint = RpcContext.getContext().getAttachment(Constants.REMOTE_ADDRESS);
